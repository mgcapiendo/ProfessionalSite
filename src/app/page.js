              ...
              <section> {/*previously i had the gray box but i dont want it anymore so no need for class name properties in this section */}
                <motion.div
                  ...
                  transition={{ 
                    ...
                    delay: 1.5 }}
                >
                <h1 className="text-4xl sm:text-6xl font-bold text-gray-900 mb-4">Hey!</h1>
                ...
                >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-4">
                    <div>
                      ...
                      <ul className='flex flex-wrap'> {/*space-y-2 adds spacing for the y-axis between the children of this tag with a space of 8px (1-20)*/}
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-800 mt-4 sm:mt-0">Technologies/Frameworks</h3>
