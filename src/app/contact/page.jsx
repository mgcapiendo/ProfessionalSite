        ...
        <motion.div
          ...
          <div className="grid grid-cols-8 lg:grid-cols-12 w-full">
                <div className="lg:col-span-7 custom-bg lg:px-16 sm:py-12 rounded-2xl flex flex-col justify-center h-auto bg-gray-100 rounded-xl shadow-lg">
                    ...
                    <div>
                      <Link className='mt-2 bg-blue-100 text-blue-500 px-3 py-1 rounded-full inline-block mr-2 text-sm  hover:bg-transparent transition-colors duration-300' href="/ManuelCapiendo_Senior_BSComputerScienceAI_NuclearIT_Integration_Navy.pdf">View Full Resume</Link>
                    </div>
